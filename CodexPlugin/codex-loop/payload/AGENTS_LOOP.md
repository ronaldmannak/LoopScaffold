...
- NEVER delete, disable, skip, or weaken a test to make it pass. Fix the implementation instead. (A hook deterministically blocks skip markers and assertion removal; do not try to work around it.)
